...
export const CalendarDaysIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    <path
      ...
      d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 12.75h.008v.008H12v-.008zm-3 0h.008v.008H9v-.008zm-3 0h.008v.008H6v-.008zm3 3h.008v.008H9v-.008zm-3 0h.008v.008H6v-.008zm6-3h.008v.008H12v-.008zm3 3h.008v.008H15v-.008zm-6-3h.008v.008H9v-.008z"
    />
  </svg>
);
